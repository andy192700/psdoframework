...
public class TestDescriptorMapperTests
{
    ...
    [Theory]
    [InlineAutoMoqData]
    public void TestDescriptorMapper_CanMapDescendingPath(
        ...
        string name)
    {
        ...
        var sut = new TestDescriptorMapper(osSanitise.Object);
        ...
        result.GetType().Should().Be(typeof(TestDescriptor));
    ...
    [Theory]
    [InlineAutoMoqData]
    public void TestDescriptorMapper_CanMapLocalPath(
        [Frozen] Mock<IOSSanitise> osSanitise,
        string name)
    {
        // Arrange
