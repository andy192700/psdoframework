...
|----------|----------|----------|----------|
| PowerShell Core | 7.6.x | Used to develop and use this framework (as it is a PowerShell Module). | [License](https://github.com/PowerShell/PowerShell/blob/master/LICENSE.txt) |
| Dotnet Core | 10.x.x | This framework's PowerShell Module is powered by a dotnet library built with using the indicated version. | [License](https://github.com/Microsoft/dotnet/blob/main/LICENSE) |
...
| System.Management.Automation | 7.6.0 | Enriches Do's dotnet library with PowerShell domain functionality. | [License](https://github.com/PowerShell/PowerShell/blob/master/LICENSE.txt) |
